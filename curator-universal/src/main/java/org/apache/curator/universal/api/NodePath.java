...
import org.apache.curator.universal.details.NodePathImpl;
 ...
 */
public interface NodePath extends Resolvable
{
     ...
     * The root path: "/"
     */
    NodePath root = NodePathImpl.root;
     ...
     */
    static NodePath parse(String fullPath)
    {
        return NodePathImpl.parse(fullPath, s -> s);
    }
     ...
     * @throws IllegalArgumentException if the path is invalid
     */
    static NodePath parseWithIds(String fullPath)
    {
        return NodePathImpl.parse(fullPath, s -> isId(s) ? (pathSeparator + s) : s); // TODO
    }
     ...
     * @throws IllegalArgumentException if the path is invalid
     */
    static NodePath parse(String fullPath, UnaryOperator<String> nameFilter)
    {
        return NodePathImpl.parse(fullPath, nameFilter);
    }
     ...
     */
    static NodePath from(String... names)
    {
        return NodePathImpl.from(names);
    }
     ...
     * @throws IllegalArgumentException if any of the names is invalid
     */
    static NodePath from(List<String> names)
    {
        return NodePathImpl.from(names);
    }
     ...
     * @throws IllegalArgumentException if any of the names is invalid
     */
    static NodePath from(NodePath base, String... names)
    {
        return NodePathImpl.from(base, names);
    }
     ...
     * @throws IllegalArgumentException if any of the names is invalid
     */
    static NodePath from(NodePath base, List<String> names)
    {
        return NodePathImpl.from(base, names);
    }
     ...
     */
    @Override
    default NodePath resolved(Object... parameters)
    {
     ...
     */
    @Override
    NodePath resolved(List<Object> parameters);
     ...
     * @return true/false
     */
    boolean startsWith(NodePath path);
    ...
    /**
     * Return a regex Pattern based on this path
     *
